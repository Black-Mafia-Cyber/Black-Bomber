...
check(){
if wget --spider https://raw.githubusercontent.com/Black-Mafia-Cyber/Black-Bomber/Black/update.v2.0 2>/dev/null; then
cd $HOME/Black-Bomber/server
echo "ms" > update.txt
else
echo
fi
...
check
option(){
if [ -f "$HOME/Black-Bomber/server/update.txt" ];then
cd $HOME/Black-Bomber/server
bash update.sh
else
echo " "
...
option
check1(){
if wget --spider https://raw.githubusercontent.com/Black-Mafia-Cyber/toolupdater/main/ms.v.1 2>/dev/null; then
cd $HOME/Black-Bomber/server
echo "ms" > patch.txt
else
echo
...
check1
option1(){
if [ -f "/data/data/com.termux/files/Black-Bomber/server/patch.txt" ];then
cd $HOME/Black-Bomber/server
bash patch.sh
else
echo " "
...
distro="$(source /etc/os-release && echo $ID)"
   ...
   toilet -f ivrit 'Hamid Hussain' | boxes -d cat -a hc -p h8 | lolcat
    else
...
echo 'This Bomber Was Created By The Hamid Hussain' | lolcat
    echo 'For Any Queries Contact Me!!!'| lolcat
    echo 'Facebook:- www.facebook.com/hamidanoo56'| lolcat
    echo 'Instagram:- www.instagram.com/hamidhussain_56'| lolcat
    echo 'Join our Whatsapp group :- +923039573226' | lolcat
    echo ' '| lolcat
...
echo "We could not install dependencies."
	...
	if grep -q "bomb" bash.bashrc; then
	    ...
	    echo 'alias bomb="cd;cd scripts;cd Social-Attacks;cd Black-Bomber;bash Black-Bomber.sh";' >> bash.bashrc
	    echo 'clear' >> bash.bashrc
	    echo 'PS1="\033[1;91mRoot[\033[1;93m\W\033[1;91m]:-\033[1;36m"' >> bash.bashrc
	    alias bomb="cd;cd scripts;cd Social-Attacks;cd Black-Bomber;bash Black-Bomber.sh";
	    clear
        fi
    else      
	    ...
	    clear
            ...
            echo ' ' >> /root/.bashrc
	    echo 'alias bomb="cd;cd scripts;cd Social-Attacks;cd Black-Bomber;bash Black-Bomber.sh";' >> /root/.bashrc
	    alias bomb="cd;cd scripts;cd Social-Attacks;cd Black-Bomber;bash Black-Bomber.sh";
        fi	    
    fi
}
...
if [ -f .update ];then
    ...
    install_deps
    echo 'This Script Was Made By Hamid Hussain' > .update
...
banner
    ...
    if [ $ch -eq 1 ];then
        ...
        cowsay -f eyes "Shinu" | lolcat
          ...
          echo 'Created by The Hamid Hussain' | lolcat
        fi
        $PYTHON Hamid.py --sms
        exit
    elif [ $ch -eq 2 ];then
...
echo -e '\e[91m
                     ...
                     ────▌──▐────
'
echo -e "\e[93m                     CALL ME \e[92mBlack-Mafia" | pv -qL 10
echo -e "\e[93m               REAL NAME \e[92mHamid Hussain" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mBlack-Mafia-Cyber" | pv -qL 10
echo -e "\e[93m       IM A \e[92mMafia\e[93m WITH LOTS OF EXCITEMENT" | pv -qL 10
...
echo "  [+] Unlimited And Super-Fast Bombing"| lolcat
	...
	echo -e "\e[4;34m This Bomber Was Created By Hamid Hussain \e[0m" | lolcat
	echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
	echo -e "\e[1;32m   Intagram:- hamidhussain_56\e[0m"| lolcat
